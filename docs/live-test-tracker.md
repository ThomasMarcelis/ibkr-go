...
deep-ITM observed working with the 10349 TIF preset notice then rejected by the
...
| pnl | 2026-07-11 | promoted to `pnl.txt` from the public API capture on read-only Gateway; server_version=206, events sha256 `eeba9a0ab7c6e1e210a5dc83aad7a2af3521795d2fba9f6571be996bc2b5c189`; one typed nonzero account PnL update was followed by cancel, wait, and a current-time fence |
...
| quote_snapshot_aapl | 2026-07-10 | promoted to `quote_snapshot.txt` from the public API capture on readonly server_version=206; all twelve typed quote fields and the snapshot-end boundary were observed; events sha256 `a854ac41c4e0073f7578f2d2ac4a2c4b1f0954bd243c49167beda62f5f159e3e` |
...
| api_duplicate_quote_subscriptions_aapl | 2026-07-11 | recorded, verified; server_version=207, events sha256 `482be884cb5dba78fd0ab0f8607d7f6f48b83e0e31790cb61d9755ff55c3b06f`; explicit close/wait plus current-time fence proves both cancellations reached the connection |
...
| api_duplicate_quote_subscriptions_aapl.txt | 20260711T034610Z | promoted from exact sv207 raw frames; covers SetType(Delayed), two independent same-contract AAPL quote streams, and both cancellations |
...
| api_market_data_type_cycle.txt | 20260415T162200Z | promoted as exact raw replay; covers bare SetType(1/2/3/4) requests accepted silently before later market-data entitlement probes (`f692fc168a53da9d935e4b102a3ce3dc940848891a9be4a2316303780e805357`) |
| api_realtime_bars_request_errors_aapl.txt | 20260711T034139Z | promoted from exact current sv207 raw frames; covers TRADES code 420, BID_ASK code 321, and MIDPOINT code 10089 request-scoped errors (`a5d5182a6a51ec31c5ae2d9bd3e8282f2f15aef4b4589377b4c1ed48454c9d05`) |
| api_tick_by_tick_entitlement_errors_aapl.txt | 20260711T044617Z | promoted from exact readonly sv207 raw frames; covers Last code 10189 plus AllLast, AllLast ignore-size, BidAsk, and MidPoint code 10089 subscription errors (`fbcc0fdd77c68930d49173e78ac96abe51b71c27c697edb8a1f3a4054cefade5`) |
| api_wsh_variants_aapl.txt | 20260415T162255Z | promoted as exact raw replay; covers WSH metadata plus conid, portfolio, watchlist, and competitor event-data variants returning real code 10276 entitlement errors (`65aeb0a3b716e4b61f60a5dbeea2690a93492426e1f95139b262b9ace4529a05`) |
