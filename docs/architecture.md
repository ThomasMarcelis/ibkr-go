...
order placement/cancellation lifecycle to protobuf. The session handshake can
negotiate 176..203 and gates fields on the returned version, but 176..199
remain compatibility paths rather than advertised support until each has
independent evidence. Version 204 and newer remain unsupported until their
...
- The advertised handshake maximum (`maxServerVersion`, currently 203) is a
