...
open/completed-order query family and completed-order replies. The session handshake can
negotiate 176..204 and gates fields on the returned version, but 176..199
remain compatibility paths rather than advertised support until each has
independent evidence. Version 205 and newer remain unsupported until their
...
- The advertised handshake maximum (`maxServerVersion`, currently 204) is a
