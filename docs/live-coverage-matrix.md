...
| AORD-006 | Hedge orders | official hedging | `api_hedge_order_aapl` | candidate | Executable scenario attaches delta, beta, FX, and pair hedge children to a staged parent; awaiting its first market-window run to freeze accept-or-reject per hedge type. |
