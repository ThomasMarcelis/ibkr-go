...
| SESS-007 | Negotiated protocol train | version gates 200..225, official API 10.48 migration table | codec exact vectors, public routing tests, `protocol-audit-sv201.md` through `protocol-audit-sv208-225.md` | promoted | Every protobuf migration through 213 and every semantic gate through 225 is implemented and fails closed at its lower boundary. Positive entitlement evidence remains owned by the affected capability row rather than weakening version negotiation. |
