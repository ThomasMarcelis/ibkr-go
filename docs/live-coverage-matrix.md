...
| ID | Capability | Public API / Official Surface | Current Scenarios / Replay | Status | Required Matrix Variants |
|----|------------|-------------------------------|----------------------------|--------|--------------------------|
| REF-001 | Contract details and qualification | `Contracts().Details`, `Contracts().Qualify`, official `reqContractDetails`, `contractDetails`, `bondContractDetails`, `contractDetailsEnd` | `contract_details_aapl_stk`, `contract_details_aapl_opt`, `contract_details_apple_bonds`, `contract_details_eurusd_cash`, `contract_details_es_fut`, `contract_details_not_found`, `qualify_contract_aapl_exact`, `qualify_contract_ambiguous`, `api_security_type_probe_matrix`, `api_security_type_probe_errors.txt`, `contract_details.txt`, `grounded_contract_details_aapl.txt`, `contract_details_aapl_opt.txt`, `contract_details_apple_bonds.txt`, `contract_details_eurusd_cash.txt`, `contract_details_es_fut.txt`, `contract_details_not_found.txt`, `qualify_contract_ambiguous.txt` | promoted | Regular classic v200 details are completely decoded and projected. Capture `9be83e57ed176a17` freezes common tails across STK/CASH/CFD/CMDTY/CONTFUT/CRYPTO/IND/FOP and the VTSAX FUND tail. Readonly-live capture `fd71d9f7bf4f470c` uses Apple issuer ID `e1432232` from matching-symbols evidence and freezes 58 message-18 bond rows; the replay retains real one- and two-security-ID variants, exact size rules, and intentionally empty unknown bond metadata. Remaining variants: BAG, expired/includeExpired, nonempty ineligibility reasons, and non-issuer security selectors. |
