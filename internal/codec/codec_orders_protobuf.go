...
var inboundProtobufDecoders = map[int]protobufDecodeFunc{
	InTickPrice:             decodeTickPriceProto,
	InTickSize:              decodeTickSizeProto,
	InMarketDepth:           decodeMarketDepthProto,
	InMarketDepthL2:         decodeMarketDepthL2Proto,
	InTickOptionComputation: decodeTickOptionComputationProto,
	InTickGeneric:           decodeTickGenericProto,
	InTickString:            decodeTickStringProto,
	InTickSnapshotEnd:       decodeTickSnapshotEndProto,
	InMarketDataType:        decodeMarketDataTypeProto,
	InTickReqParams:         decodeTickReqParamsProto,
