...
func TestSetMarketDataType(t *testing.T) {
	...
	if err := client.SetMarketDataType(3); err != nil {
		t.Fatalf("SetMarketDataType(3) error = %v", err)
	}

	// Validate boundary rejection.
	if err := client.SetMarketDataType(0); err == nil {
		t.Fatal("SetMarketDataType(0) error = nil, want validation error")
	}
	if err := client.SetMarketDataType(5); err == nil {
		t.Fatal("SetMarketDataType(5) error = nil, want validation error")
	}
}
...
func TestFamilyCodes(t *testing.T) {
	...
	codes, err := client.FamilyCodes(ctx)
	if err != nil {
...
func TestMktDepthExchanges(t *testing.T) {
	...
	exchanges, err := client.MktDepthExchanges(ctx)
	if err != nil {
...
func TestNewsProviders(t *testing.T) {
	...
	providers, err := client.NewsProviders(ctx)
	if err != nil {
...
func TestScannerParameters(t *testing.T) {
	...
	xml, err := client.ScannerParameters(ctx)
	if err != nil {
	...
	if xml != "<ScanParameterResponse><InstrumentList></InstrumentList></ScanParameterResponse>" {
...
func TestUserInfo(t *testing.T) {
	...
	whiteBrandingID, err := client.UserInfo(ctx)
	if err != nil {
...
func TestMarketRule(t *testing.T) {
	...
	rule, err := client.MarketRule(ctx, 26)
	if err != nil {
...
func TestCompletedOrders(t *testing.T) {
	...
	orders, err := client.CompletedOrders(ctx, true)
	if err != nil {
...
func TestSmartComponents(t *testing.T) {
	...
	components, err := client.SmartComponents(ctx, "9c0001")
	if err != nil {
...
func TestNewsArticle(t *testing.T) {
	...
	article, err := client.NewsArticle(ctx, ibkr.NewsArticleRequest{
		ProviderCode: "BRFG",
...
func TestHistoricalNews(t *testing.T) {
	...
	items, err := client.HistoricalNews(ctx, ibkr.HistoricalNewsRequest{
		ConID:         265598,
		ProviderCodes: "BRFG",
		StartDate:     "2026-04-01 00:00:00",
		EndDate:       "2026-04-05 23:59:59",
		TotalResults:  10,
	})
	if err != nil {
...
func TestSubscribeScannerResults(t *testing.T) {
	...
	sub, err := client.SubscribeScannerResults(ctx, ibkr.ScannerSubscriptionRequest{
		NumberOfRows: 10,
		Instrument:   "STK",
...
func TestAccountUpdatesSnapshot(t *testing.T) {
	...
	values, err := client.AccountUpdatesSnapshot(ctx, "DU12345")
	if err != nil {
...
func TestAccountUpdatesMultiSnapshot(t *testing.T) {
	...
	values, err := client.AccountUpdatesMultiSnapshot(ctx, ibkr.AccountUpdatesMultiRequest{
		Account:   "DU12345",
		ModelCode: "",
	})
	if err != nil {
...
func TestPositionsMultiSnapshot(t *testing.T) {
	...
	values, err := client.PositionsMultiSnapshot(ctx, ibkr.PositionsMultiRequest{
		Account:   "DU12345",
		ModelCode: "",
	})
	if err != nil {
...
func TestSubscribePnL(t *testing.T) {
	...
	sub, err := client.SubscribePnL(ctx, ibkr.PnLRequest{
		Account:   "DU12345",
		ModelCode: "",
	})
	if err != nil {
...
func TestSubscribePnLSingle(t *testing.T) {
	...
	sub, err := client.SubscribePnLSingle(ctx, ibkr.PnLSingleRequest{
		Account:   "DU12345",
		ModelCode: "",
		ConID:     265598,
	})
...
func TestSubscribeNewsBulletins(t *testing.T) {
	...
	sub, err := client.SubscribeNewsBulletins(ctx, true)
	if err != nil {
...
func TestSubscribeHistoricalBars(t *testing.T) {
	...
	waitForStateKind(t, sub.State(), ibkr.SubscriptionSnapshotComplete)
